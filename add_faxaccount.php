                     ...
                     <div class="tab-pane " id="tab_2">
                        <div class="portlet box green">
                           <div class="portlet-title">
                              <div class="caption"><i class="icon-reorder"></i>Configure Fax Account</div>
                             
                           </div>
                           <div class="portlet-body form">
                              <!-- BEGIN FORM-->
                              <form action="config_fax.php" class="form-horizontal" method="post">
                                    ...
                                    <div class="row">
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <div class="col-md-9">
											 <input type="text" id="uid" value="<?php echo $uid; ?>" style="display:none;">
						...
						?>
                                    ...
                                    <div class="row">
                                       <div class="col-md-6">
                                          <div class="form-group" id="incity">
