...
<body class="login">
	<!-- BEGIN LOGO -->
	<div class="logo">
		<img src="assets/img/logo_myfax_400x400.jpg" alt="" /> 
	</div>
	<!-- END LOGO -->
	<!-- BEGIN LOGIN -->
	<div class="content">
	<div id="info1"></div>
		...
		<form class="login-form" action="logindb.php" method="post">
			...
			<div class="create-account">
				<p>
					Don't have an <B> E-FAX </B> account yet ?&nbsp; 
		...
		<form class="forget-form" action="index.html" method="post">
			...
			<div class="form-actions">
				...
				<button type="submit" class="btn green pull-right" id="forgot">
...
$("#forgot").click(function(e) {
  e.preventDefault();
   ...
   if(data1 == "")
   {
   $("#info").html('<div class="alert alert-warning">Please Enter Your Email.</div>');
   }
   else
   {
   $("#info").html('<div class="alert alert-warning">Please wait.....</div>');
 
 
  var dataString = 'email='+data1;
  $.ajax({
    type:'POST',
    data:dataString,
    url:'mail.php',
    success:function(data) {
      $("#info").html('<div class="alert alert-success"><strong>Success!</strong> Password has been mail.</div>');
