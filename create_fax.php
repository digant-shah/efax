                     ...
                     <div class="tab-pane " id="tab_2">
                        <div class="portlet box green">
                           ...
                           <div class="portlet-body form">
                              <!-- BEGIN FORM-->
                              <form action="faxdb.php" class="form-horizontal" method="post" enctype="multipart/form-data">
                                 <div class="form-body">
                              ...
                              <div class="col-md-9">
                                 <textarea class="wysihtml5 form-control" rows="6" name="textbody"></textarea>
                              </div>
                           </div>
                                    ...
                                    <div class="row">
                                       <div class="col-md-6">
                                          <div class="col-md-offset-3 col-md-9">
                                             <input type="submit" class="btn green" value="Send Fax">
